...
public enum GatewayCommands {
    ...
    GW_GET_SCENE_INFORMATION_REQ((short) 0x040F),
    /** Acknowledge to GW_GET_SCENE_INFORMATION_REQ. */
    GW_GET_SCENE_INFORMATION_CFM((short) 0x0410),
    /** Acknowledge to GW_GET_SCENE_INFORMATION_REQ. */
    GW_GET_SCENE_INFORMATION_NTF((short) 0x0411),
    ...
    GatewayCommands(short commandNumber) {
     ...
     * @return the {@link GatewayCommands} matching commandNumber if found, null otherwise
     */
    public static GatewayCommands fromNumber(short commandNumber) {
        for (GatewayCommands testCommand : values()) {
