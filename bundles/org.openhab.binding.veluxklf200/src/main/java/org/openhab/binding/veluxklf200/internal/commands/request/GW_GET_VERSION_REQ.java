 ...
 */
@NonNullByDefault
public class GW_GET_VERSION_REQ extends BaseRequest<GW_GET_VERSION_CFM> {

    public GW_GET_VERSION_REQ() {
        super(GatewayCommands.GW_GET_VERSION_REQ);
    }
    ...
    @Override
    public boolean handleResponseImpl(GW_GET_VERSION_CFM response) {
        return true;
    }
}
